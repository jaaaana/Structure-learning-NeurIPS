# PC Algorithm Settings Comparison -- Step 3 (v4)
...
main                       continuous   fisherz   0.01   True    3         0           0                   
main                       continuous   fisherz   0.01   False   4         0           3                   
main                       continuous   fisherz   0.05   True    4         0           0                   
main                       continuous   fisherz   0.05   False   4         2           1                   
main                       continuous   fisherz   0.1    True    6         0           0                   
main                       continuous   fisherz   0.1    False   7         1           1                   
main                       discretized  chisq     0.01   True    3         0           0                   
main                       discretized  chisq     0.01   False   0         3           0                   
main                       discretized  chisq     0.05   True    5         0           0                   
main                       discretized  chisq     0.05   False   3         2           3                   
main                       discretized  chisq     0.1    True    5         0           0                   
main                       discretized  chisq     0.1    False   4         1           2                   
main                       continuous   kci       0.01   True    4         0           0                   
main                       continuous   kci       0.01   False   2         2           2                   
main                       continuous   kci       0.05   True    6         0           0                   
main                       continuous   kci       0.05   False   7         1           4                   
main                       continuous   kci       0.1    True    5         0           0                   
main                       continuous   kci       0.1    False   5         1           3                   
sensitivity_outcome:topic_growth continuous   fisherz   0.05   True    5         0           0                   
sensitivity_outcome:topic_growth discretized  chisq     0.05   True    3         0           0                   
sensitivity_outcome:topic_growth continuous   fisherz   0.05   False   2         3           1                   
sensitivity_outcome:topic_growth discretized  chisq     0.05   False   3         1           0                   
sensitivity_outcome:hit_rate_2yr continuous   fisherz   0.05   True    4         0           0                   
sensitivity_outcome:hit_rate_2yr discretized  chisq     0.05   True    3         0           0                   
sensitivity_outcome:hit_rate_2yr continuous   fisherz   0.05   False   5         1           1                   
sensitivity_outcome:hit_rate_2yr discretized  chisq     0.05   False   5         0           1                   
sensitivity_no_year        continuous   fisherz   0.05   True    3         0           0                   
sensitivity_no_year        discretized  chisq     0.05   True    2         0           0                   
sensitivity_no_year        continuous   fisherz   0.05   False   5         1           2                   
sensitivity_no_year        discretized  chisq     0.05   False   0         2           0                   
sensitivity_size_control   continuous   fisherz   0.01   True    4         0           0                   
sensitivity_size_control   continuous   fisherz   0.01   False   2         2           2                   
sensitivity_size_control   continuous   fisherz   0.05   True    4         0           0                   
...
- `topic_share_t1` -> `topic_share_t`
- `year` -> `connectivity_t1_log`
- `connectivity_t1_log` -> `topic_share_t`
- `modularity_t1` -> `topic_share_t`
- `year` -> `log1p_median_c2`
...
- `modularity_t1` -> `connectivity_t1_log`
- `year` -> `connectivity_t1_log`
- `topic_share_t` -> `connectivity_t1_log`  [TEMPORAL VIOLATION]
- `modularity_t1` -> `topic_share_t`
Undirected / ambiguous:
- `log1p_median_c2` -- `year`
...
- `year` -> `topic_share_t1`
- `year` -> `connectivity_t1_log`
- `connectivity_t1_log` -> `topic_growth`
- `year` -> `modularity_t1`
...
Directed:
- `year_bin` -> `topic_share_t1_bin`
- `topic_share_t1_bin` -> `topic_growth_bin`
- `year_bin` -> `connectivity_t1_bin`
...
Directed:
- `year` -> `connectivity_t1_log`
- `topic_growth` -> `connectivity_t1_log`  [TEMPORAL VIOLATION]
Undirected / ambiguous:
- `modularity_t1` -- `topic_share_t1`
- `topic_share_t1` -- `year`
- `modularity_t1` -- `year`
...
Directed:
- `connectivity_t1_log` -> `topic_share_t1`
- `modularity_t1` -> `topic_share_t1`
- `topic_share_t` -> `topic_share_t1`  [TEMPORAL VIOLATION]
- `connectivity_t1_log` -> `modularity_t1`
- `log1p_median_c2` -> `modularity_t1`  [TEMPORAL VIOLATION]
Undirected / ambiguous:
- `log1p_median_c2` -- `topic_share_t`
...
```
     ...
     topic_share_t1       topic_share_t                    9                 9           1.000                    9                              1.0
               ...
               year      topic_share_t1                    3                 9           0.333                    3                              1.0
    connectivity_t1     log1p_median_c2                    3                 9           0.333                    3                              1.0
               year cross_topic_rate_t1                    2                 9           0.222                    2                              1.0
               year       modularity_t1                    2                 9           0.222                    2                              1.0
      modularity_t1       topic_share_t                    1                 9           0.111                    1                              1.0
    connectivity_t1       topic_share_t                    1                 9           0.111                    1                              1.0
      modularity_t1     log1p_median_c2                    1                 9           0.111                    1                              1.0
cross_topic_rate_t1     log1p_median_c2                    1                 9           0.111                    1                              1.0
```
